	...
	echo "<br/>";
			if(isset($_GET['rollno']) && isset($_GET['sem']))
		{
			...
			if($result1['InternalTest1'])
			{
				...
				echo "<tr>";
				foreach($sub1 as $key1 => $value1)
				echo "<th>".$value1."</th>";
				echo "</tr>";
				echo "<tr>";
				foreach($mark1 as $key1 => $value1)
				echo "<td>".@ $value1."</td>";
				echo "</tr>";
				echo "</table>";
				echo "</div>";
			...
			if($result1['ModelExam'])
			{
				...
				echo "<table align='center' border='1'>";
				echo "<tr>";
				foreach($sub3 as $key3 => $value3)
				echo "<th>".$value3."</th>";
				echo "</tr>";
				echo "<tr>";
				foreach($mark3 as $key3 => $value3)
				echo "<td>".@ $value3."</td>";
				echo "</tr>";
				echo "</table>";
				echo "</div>";
			...
			if($result1['gpa'])
			{
				...
				echo "<table align='center' border='1'>";
				echo "<tr>";
				foreach($sub4 as $key4 => $value4)
				echo "<th>".$value4."</th>";
				echo "</tr>";
				echo "<tr>";
				foreach($mark4 as $key4 => $value4)
				{
				echo "<td>".@ $value4."</td>";
				if($value4 == "U")
				$u++;
...
@			$abs=array_count_values(unserialize($atn));
			...
			echo "<center><b>Number of AR : ".$u."</b></center>" ;
		}	
